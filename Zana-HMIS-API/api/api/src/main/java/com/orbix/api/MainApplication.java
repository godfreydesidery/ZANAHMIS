	...
	CommandLineRunner run(UserService userService, DayService dayService, CompanyProfileService companyProfileService) {
		return args -> {
			if(!companyProfileService.hasData()) {
				...
				CompanyProfile company = new CompanyProfile(null, "Company Name","Contact Name", null, "NAN", "NAN", "NAN", "NAN", "NAN", "NAN", "NAN", "NAN", "NAN", "NAN", "NAN", "NAN", "NAN", "NAN", "NAN", "NAN", "NAN", "NAN", "NAN", "NAN", "NAN", "NAN", "NAN", "NAN", "NAN", "NAN", "NAN", "NAN", "", "");
