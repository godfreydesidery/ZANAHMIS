...
@Component({
  selector: 'app-patient-insurance-invoices',
  templateUrl: './patient-insurance-invoices.component.html',
  styleUrls: ['./patient-insurance-invoices.component.scss'],
  standalone : true,
  imports : [
    CommonModule,
    FormsModule,
...
export class PatientInsuranceInvoicesComponent {
  ...
  async loadPatientDirectInvoices(){
    ...
    this.spinner.show()
    await this.http.get<IPatientInvoice[]>(API_URL+'/patients/get_patient_insurance_pending_invoices', options)
