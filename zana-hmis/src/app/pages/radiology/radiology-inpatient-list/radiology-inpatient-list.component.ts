...
@Component({
  selector: 'app-radiology-inpatient-list',
  templateUrl: './radiology-inpatient-list.component.html',
...
export class RadiologyInpatientListComponent {
  ...
  constructor(private auth : AuthService,
    ...
    async attend(id : any){
      ...
      await this.router.navigate(['radiology'])
    }
    ...
    async loadInpatientList(){   
      ...
      this.spinner.show()
      await this.http.get<IPatient[]>(API_URL+'/patients/get_radiology_inpatient_list', options)
